...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		// Register the GameUserRESTController from the Security example
		...
		// Create client object as JerseyClientBuilder instance assigned to the REST client reference from the Security example
		final Client client = new JerseyClientBuilder(e).build("DemoRESTClient");
		// Register the RestClientController client
